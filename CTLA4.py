...
file_name = 'smaller sampling range RT ' + str(RT_fractions) + ' PD ' + str(PD_fractions) + ' CTLA4 ' + str(CTLA4_fractions) + ' ' + str(initial_cell_count) + ' knew.csv'
...
#     print('k', k)
#     print(params[k])
args = [(k, params) for k in range(8400,min(iterations,8800))]
